...
const About = () =>{
    return(
          ...
          <div className="flex mt-6 flex-col lg:mx-20 lg:py-6">
            <div>
            ...
            <div className="lg:w-[800px] w-[300px] mt-10 lg:mt-56">
                    ...
                    <p className="ml-20 mt-5">We're passionate about curating skincare routines that fit seamlessly into your daily life. Each product is crafted with care, balancing traditional remedies with modern science to address your skin’s unique needs. From our gentle cleansers to our rejuvenating serums, every item in our collection is a testament to our commitment to quality, purity, and transparency.</p>
            </div>
          </div>
